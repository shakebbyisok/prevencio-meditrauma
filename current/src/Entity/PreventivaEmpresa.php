...
/**
 * @ORM\Entity(repositoryClass="App\Repository\PreventivaEmpresaRepository")
 * @Gedmo\Mapping\Annotation\Loggable()
 */
class PreventivaEmpresa
{
    /**
     * @ORM\Id()
     * @ORM\GeneratedValue()
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\GrupoPreventiva", inversedBy="PreventivaEmpresa")
