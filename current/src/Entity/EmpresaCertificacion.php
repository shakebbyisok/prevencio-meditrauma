...
/**
 * @ORM\Entity(repositoryClass="App\Repository\EmpresaCertificacionRepository")
 * @Gedmo\Mapping\Annotation\Loggable()
 */
class EmpresaCertificacion
{
    /**
     * @ORM\Id()
     * @ORM\GeneratedValue()
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\Empresa", inversedBy="EmpresaCertificacion")
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\GdocFichero", inversedBy="EmpresaCertificacion")
     * @ORM\JoinColumn(nullable=true)
     * @Gedmo\Mapping\Annotation\Versioned()
     */
    private $fichero;
