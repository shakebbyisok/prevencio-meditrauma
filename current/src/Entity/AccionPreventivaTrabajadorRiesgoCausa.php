...
/**
 * @ORM\Entity(repositoryClass="App\Repository\AccionPreventivaTrabajadorRiesgoCausaRepository")
 * @Gedmo\Mapping\Annotation\Loggable()
 */
class AccionPreventivaTrabajadorRiesgoCausa
{
    /**
     * @ORM\Id()
     * @ORM\GeneratedValue()
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\Trabajador", inversedBy="AccionPreventivaTrabajadorRiesgoCausa")
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\ResponsableExterno", inversedBy="AccionPreventivaTrabajadorRiesgoCausa")
     * @ORM\JoinColumn(nullable=true)
     * @Gedmo\Mapping\Annotation\Versioned()
     */
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\EmpresaExterna", inversedBy="AccionPreventivaTrabajadorRiesgoCausa")
     * @ORM\JoinColumn(nullable=true)
     * @Gedmo\Mapping\Annotation\Versioned()
     */
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\RiesgoCausaEvaluacion", inversedBy="AccionPreventivaTrabajadorRiesgoCausa")
     * @ORM\JoinColumn(nullable=true)
     * @Gedmo\Mapping\Annotation\Versioned()
     */
    private $riesgoCausa;
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\PreventivaTrabajador", inversedBy="AccionPreventivaTrabajadorRiesgoCausa")
     * @ORM\JoinColumn(nullable=true)
     * @Gedmo\Mapping\Annotation\Versioned()
     */
