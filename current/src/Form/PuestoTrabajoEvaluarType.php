...
class PuestoTrabajoEvaluarType extends AbstractType
{
...
//            ->add('trabajadores', TextType::class, ['label' => 'TRANS_NUMERO_TRABAJADORES', 'translation_domain' => 'evaluacion', 'required' => false])
            ->add('tarea', TextareaType::class, ['label' => 'TRANS_TAREAS', 'translation_domain' => 'evaluacion', 'required' => false])
    ...
    public function configureOptions(OptionsResolver $resolver)
    {
        $resolver->setDefaults([
            'data_class' => PuestoTrabajoEvaluacion::class,
        ]);
    }
}
