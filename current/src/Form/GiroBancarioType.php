...
class GiroBancarioType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
	        ...
	        ->add('vencimiento', DateType::class, ['label' => 'TRAN_FECHA_VENCIMIENTO', 'translation_domain' => 'balanceeconomico', 'required' => false, 'widget' => 'single_text', 'html5' => true])
	        ->add('importe', NumberType::class, ['label' => 'TRANS_IMPORTE_FACTURA', 'translation_domain' => 'balanceeconomico', 'required' => false, 'scale' => 2, 'attr' => array( 'min'  => 0, 'max'  => 999999999.99, 'step' => 0.01)])
