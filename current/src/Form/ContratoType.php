...
class ContratoType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
	        ...
	        ->add('contratoModalidad', EntityType::class, ['class' => ContratoModalidad::class, 'required' => true,  'choice_label' => 'descripcion', 'translation_domain' => 'contratos', 'placeholder' => '',  'empty_data' => null, 'query_builder' => function (EntityRepository $er) use ($options) {
                return $er->createQueryBuilder('u')
	        ...
	        ->add('centro', EntityType::class, ['class' => Centro::class, 'required' => false, 'choice_label' => 'nombre', 'placeholder' => '', 'data' => $options['centroObj'], 'empty_data' => null, 'query_builder' => function (EntityRepository $er) use ($options) {
                return $er->createQueryBuilder('u')
                    ->where('u.id IN (:id)')
                    ->setParameter('id', $options['centroId']);
            }, 'attr' => ['class' => 'select-search']])
	        ...
	        ->add('importeContrato', NumberType::class, ['label' => 'TRANS_IMPORTE_CONTRATO', 'translation_domain' => 'contratos', 'required' => false, 'scale' => 3, 'attr' => array( 'min'  => 0, 'max'  => 999999999.99, 'step' => 0.01)])
	        ->add('importeExentoIva', NumberType::class, ['label' => 'TRANS_IMPORTE_EXENTO_IVA', 'translation_domain' => 'contratos', 'required' => false, 'scale' => 3, 'attr' => array( 'min'  => 0, 'max'  => 999999999.99, 'step' => 0.01)])
	        ->add('importeSujetoIva', NumberType::class, ['label' => 'TRANS_IMPORTE_CONTRATO_SUJETO_IVA', 'translation_domain' => 'contratos', 'required' => false, 'scale' => 3, 'attr' => array( 'min'  => 0, 'max'  => 999999999.99, 'step' => 0.01)])
	        ->add('importeIva', NumberType::class, ['label' => 'TRANS_IMPORTE_IVA', 'translation_domain' => 'contratos', 'required' => false, 'scale' => 3, 'attr' => array( 'min'  => 0, 'max'  => 9999.99, 'step' => 0.01)])
...
//	        ->add('vencimientoPago', NumberType::class, ['label' => 'TRANS_VENCIMIENTO_PAGOS', 'translation_domain' => 'contratos', 'required' => false, 'attr' => array( 'min'  => 0, 'max'  => 9999)])
            ...
            ->add('pagoDia', NumberType::class, ['label' => 'TRANS_DIA_PAGO', 'translation_domain' => 'contratos', 'required' => false, 'mapped' => false, 'attr' => array( 'min'  => 0, 'max'  => 9999)])
            ->add('pagoFrecuencia', ChoiceType::class, ['choices' => ['TRANS_MES' => 1, 'TRANS_AÑO' => 2], 'label' => false, 'translation_domain' => 'contratos', 'mapped' => false, 'expanded' => true, 'multiple' => false, 'required' => false, 'empty_data' => null, 'placeholder' => false])
            ->add('cancelado', CheckboxType::class, ['label' => 'TRANS_CANCELADO', 'translation_domain' => 'contratos', 'required' => false, 'attr' => ['class' => 'form-check-input-styled']])
            ->add('facturado', CheckboxType::class, ['label' => 'TRANS_FACTURADO', 'translation_domain' => 'contratos', 'required' => false, 'attr' => ['class' => 'form-check-input-styled']])
