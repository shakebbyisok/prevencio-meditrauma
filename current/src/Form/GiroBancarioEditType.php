...
class GiroBancarioEditType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
	        ...
	        ->add('girado', CheckboxType::class, ['label' => 'TRANS_GIRADO', 'translation_domain' => 'balanceeconomico', 'required' => false, 'attr' => ['class' => 'form-check-input-styled']])
	        ->add('manual', CheckboxType::class, ['label' => 'TRANS_MANUAL', 'translation_domain' => 'balanceeconomico', 'required' => false, 'attr' => ['class' => 'form-check-input-styled']])
	        ...
	        ->add('esFactura', CheckboxType::class, ['label' => 'TRANS_ES_FACTURA', 'translation_domain' => 'balanceeconomico', 'required' => false, 'attr' => ['class' => 'form-check-input-styled']])
	        ->add('devolucion', CheckboxType::class, ['label' => 'TRANS_DEVOLUCION', 'translation_domain' => 'balanceeconomico', 'required' => false, 'attr' => ['class' => 'form-check-input-styled']])
	        ->add('comision', CheckboxType::class, ['label' => 'TRANS_COMISION', 'translation_domain' => 'balanceeconomico', 'required' => false, 'attr' => ['class' => 'form-check-input-styled']])
            ->add('remesado', CheckboxType::class, ['label' => 'TRANS_GIRO_REMESADO', 'translation_domain' => 'balanceeconomico', 'required' => false, 'attr' => ['class' => 'form-check-input-styled']])
