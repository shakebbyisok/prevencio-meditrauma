...
class GdocTrabajadorType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
	        ...
	        ->add('carpeta', EntityType::class, ['class' => GdocTrabajadorCarpeta::class, 'required' => true, 'choice_label' => 'nombre', 'empty_data' => null, 'disabled' => false, 'query_builder' => function (EntityRepository $er) use ($options) {
                return $er->createQueryBuilder('u')
                    ->where('u.trabajador = :trabajador')
    ...
    public function configureOptions(OptionsResolver $resolver)
    {
        $resolver->setDefaults([
            'data_class' => GdocTrabajador::class,
	        'empresaId' => null,
	        'empresaObj' => null,
            'trabajadorId' => null
        ]);
