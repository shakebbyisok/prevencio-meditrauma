...
class EmpresaType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
	        ...
	        ->add('codigoEmpresa', EntityType::class, ['class' => CodigoEmpresa::class, 'label' => 'TRANS_TIPO', 'translation_domain' => 'empresas', 'required' => true, 'choice_label' => 'codigoDescripcion', 'placeholder' => '', 'empty_data' => null, 'attr' => ['class' => 'select-search']])
	        ->add('cif', TextType::class, ['label' => 'CIF', 'required' => false])
            ->add('empresa', TextType::class, ['label' => 'TRANS_NOMBRE', 'translation_domain' => 'empresas', 'required' => true])
	        ...
	        ->add('estadoAdministrativoVigilanciaSalud', EntityType::class, ['class' => EstadoEmpresaSalud::class, 'label' => 'TRANS_ESTADO_ADM_VIG', 'translation_domain' => 'empresas', 'required' => false, 'choice_label' => 'descripcion', 'placeholder' => '', 'empty_data' => null, 'attr' => ['class' => 'select-search']])
	        ...
	        ->add('fechaAlta', DateType::class, ['label' => 'TRANS_FECHA_ALTA', 'translation_domain' => 'empresas', 'required' => false, 'widget' => 'single_text', 'html5' => true])
	        ->add('fechaBaja', DateType::class, ['label' => 'TRANS_FECHA_BAJA', 'translation_domain' => 'empresas', 'required' => false, 'widget' => 'single_text', 'html5' => true])
	        ->add('motivoBaja', TextareaType::class, ['label' => 'TRANS_MOTIVO_BAJA', 'translation_domain' => 'empresas', 'required' => false])
            ...
            ->add('noAplicarIpc', CheckboxType::class, ['label' => 'TRANS_NO_APLICAR_IPC', 'translation_domain' => 'empresas', 'required' => false, 'attr' => ['class' => 'form-check-input-styled']])
            ...
            ->add('centroTrabajoDeslocalizado', CheckboxType::class, ['label' => 'TRANS_DESLOCALIZADO', 'translation_domain' => 'empresas', 'required' => false, 'attr' => ['class' => 'form-check-input-styled']])
            ->add('centroTrabajoDeslocalizadoConstruccio', CheckboxType::class, ['label' => 'TRANS_DESLOCALIZADO_CONSTRUCCIO', 'translation_domain' => 'empresas', 'required' => false, 'attr' => ['class' => 'form-check-input-styled']])
            ->add('centroTrabajoTiene1', CheckboxType::class, ['label' => 'TRANS_TIENE_1_CENTRO', 'translation_domain' => 'empresas', 'required' => false, 'attr' => ['class' => 'form-check-input-styled']])
            ->add('centroTrabajoTiene2', CheckboxType::class, ['label' => 'TRANS_TIENE_MAS_2_CENTROS', 'translation_domain' => 'empresas', 'required' => false, 'attr' => ['class' => 'form-check-input-styled']])

            ->add('formaPagoRml', EntityType::class, ['class' => FormaPago::class, 'label' => 'TRANS_FORMA_PAGO_RML', 'translation_domain' => 'empresas', 'required' => false, 'choice_label' => 'descripcion', 'placeholder' => '', 'empty_data' => null, 'attr' => ['class' => 'select-search']])
