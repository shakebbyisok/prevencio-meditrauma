...
class EmpresaTecnicoType extends AbstractType
{
...
//            ->add('codigoTecnico',  TextType::class, ['label' => 'TRANS_CODIGO', 'translation_domain' => 'empresas', 'required' => false])
            ...
            ->add('estadoAdministrativoPrevencion', EntityType::class, ['class' => EstadoEmpresa::class, 'label' => 'TRANS_ESTADO', 'translation_domain' => 'empresas', 'required' => false, 'disabled' => true, 'choice_label' => 'descripcion', 'placeholder' => '', 'empty_data' => null, 'attr' => ['class' => 'select-search']])
...
//            ->add('anulado', CheckboxType::class, ['label' => false, 'required' => false, 'disabled' => true, 'attr' => ['class' => 'form-check-input-switch', 'data-on-color' => 'danger', 'data-off-color' => 'success', 'data-on-text' => 'No activa', 'data-off-text' => 'Activa']])
            ...
            ->add('procesoProductivo', TextareaType::class, ['label' => 'TRANS_PRCOCESO_PRODUCTIVO', 'translation_domain' => 'empresas', 'required' => false])
            ->add('fechaContrato', DateType::class, ['label' => 'TRANS_FECHA_CONTRATO', 'translation_domain' => 'empresas', 'data' => $options['fechaContrato'], 'mapped' => false, 'disabled' => true, 'required' => false, 'widget' => 'single_text', 'html5' => true])
            //Peticio 01/09/2023
            //->add('fechaProximaVisita', DateType::class, ['label' => 'Proxima Visita', 'translation_domain' => 'empresas', 'required' => false, 'widget' => 'single_text', 'html5' => true])
