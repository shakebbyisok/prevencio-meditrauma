...
class TrabajadorType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
	        ...
	        ->add('puestoTrabajo', EntityType::class, ['class' => PuestoTrabajo::class, 'choice_label' => 'descripcion', 'label' => 'TRANS_PUESTO_TRABAJO', 'translation_domain' => 'trabajadores', 'required' => false, 'empty_data' => null, 'placeholder' => false, 'attr' => ['class' => 'select-search']])
