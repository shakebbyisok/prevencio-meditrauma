...
class FacturacionType extends AbstractType
{
    ...
    {
        $builder
//	        ->add('contrato', EntityType::class, ['class' => Contrato::class, 'required' => false, 'choice_label' => 'contratoEmpresa', 'placeholder' => '', 'empty_data' => null, 'attr' => ['class' => 'select-search']])
	        ->add('numFac',  TextType::class, ['label' => 'TRANS_FACTURA', 'translation_domain' => 'facturacion', 'required' => false])
	        ->add('empresa', EntityType::class, ['class' => Empresa::class, 'required' => false, 'disabled' => false,  'choice_label' => 'empresa', 'empty_data' => null, 'data' => $options['empresaObj'], 'query_builder' => function (EntityRepository $er) use ($options) {
