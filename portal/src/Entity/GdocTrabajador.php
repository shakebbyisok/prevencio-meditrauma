...
use App\Repository\GdocTrabajadorRepository;
use Doctrine\ORM\Mapping as ORM;

/**
 * @ORM\Entity(repositoryClass=GdocTrabajadorRepository::class)
 * @Gedmo\Mapping\Annotation\Loggable()
 */
class GdocTrabajador
{
    /**
     * @ORM\Id()
     * @ORM\GeneratedValue()
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\User", inversedBy="GdocTrabajador")
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\GdocTrabajadorCarpeta", inversedBy="GdocTrabajador")
     * @ORM\JoinColumn(nullable=true)
     * @Gedmo\Mapping\Annotation\Versioned()
     */
    private $carpeta;
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Application\Sonata\MediaBundle\Entity\Media", inversedBy="GdocTrabajador")
     * @ORM\JoinColumn(nullable=true)
     * @Gedmo\Mapping\Annotation\Versioned()
     */
    private $media;
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\Trabajador", inversedBy="GdocTrabajador")
     * @ORM\JoinColumn(nullable=true)
     * @Gedmo\Mapping\Annotation\Versioned()
     */
    private $trabajador;
